                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="email" disabled class="form-control" value="{{ auth()->user()->email }}" placeholder="Your Email">
                        </div>
                        <div class="row mt-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="address" class="form-control" value="{{ auth()->user()->address }}" placeholder="Your Address">
                            </div>
                        </div>
